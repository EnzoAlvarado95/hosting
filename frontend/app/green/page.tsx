...
export default function CasaAgua() {
  ...
  return (
    <div className="min-h-screen bg-white text-gray-800">
      ...
      <div className="max-w-5xl mx-auto p-4 sm:p-6 pt-28">
        ...
        {/* Título */}
        <h1 className="text-3xl sm:text-4xl font-bold mb-4">Casa Green</h1>
        ...
        <div className="bg-gray-50 p-4 sm:p-6 rounded-2xl shadow mb-6">
          <h2 className="text-xl sm:text-2xl font-semibold mb-3">Dirección de la Casa Green</h2>
          <p className="text-gray-800 leading-relaxed text-sm sm:text-base">
            Colonia: Barrio de Guadalupe Calle: Plande de ayutla #115 Edificio 9 Departamento 6 Aguascalientes, México
          </p>
        </div>
  ...
  <p className="text-gray-800 leading-relaxed text-sm sm:text-base">
    <a
      href="https://www.airbnb.com/h/andaligreen"
      target="_blank"
      rel="noopener noreferrer"
      className="text-blue-600 hover:underline"
    >
      airbnb.com/h/andaligreen
    </a>
  </p>
</div>
