...
export default function CasaAgua() {
  ...
  const fotos = [
    ...
    "travel/travel12.jpeg",
    "travel/travel13.jpeg",
    "travel/travel14.jpeg",
    "travel/travel15.jpeg",
    "travel/travel16.jpeg",
    "travel/travel17.jpeg",
    "travel/travel18.jpeg",
    "travel/travel19.jpeg",
    "travel/travel20.jpeg",
    "travel/travel21.jpeg",
    "travel/travel22.jpeg",
    "travel/travel23.jpeg",
    "travel/travel24.jpeg",
    "travel/travel25.jpeg",
    "travel/travel26.jpeg",
    "travel/travel27.jpeg",
    "travel/travel28.jpeg",
    "travel/travel29.jpeg",
  ];
  ...
  return (
    <div className="min-h-screen bg-white text-gray-800">
      ...
      <div className="max-w-5xl mx-auto p-4 sm:p-6 pt-28">
        ...
        {/* Título */}
        <h1 className="text-3xl sm:text-4xl font-bold mb-4">Casa Travel</h1>
        ...
        <div className="bg-gray-50 p-4 sm:p-6 rounded-2xl shadow mb-6">
          <h2 className="text-xl sm:text-2xl font-semibold mb-3">Dirección de la Casa Travel</h2>
          <p className="text-gray-800 leading-relaxed text-sm sm:text-base">
            Colonia: Barrio de Guadalupe Calle: Plande de ayutla #115 Edificio 6 Departamento 6 Aguascalientes, México
          </p>
        </div>
  ...
  <p className="text-gray-800 leading-relaxed text-sm sm:text-base">
    <a
      href="https://www.airbnb.com/h/deptravelandali"
      target="_blank"
      rel="noopener noreferrer"
      className="text-blue-600 hover:underline"
    >
      airbnb.com/h/deptravelandali
    </a>
  </p>
</div>
        ...
        <div className="bg-gray-50 p-4 sm:p-6 rounded-2xl shadow mb-6">
          ...
          <ul className="text-gray-800 list-disc ml-6 space-y-2">
            <h3 className="text-2xl">Vistas panorámicas</h3>
            <li>Vista al horizonte de la ciudad</li>
            ...
            <li>Televisión HD con pantalla de 32" y servicio de cable premium</li>
            <h3 className="text-2xl">Calefacción</h3>
            <li>Ventiladores portables</li>
            ...
            <h3 className="text-2xl">Caracteristicas de la ubicación</h3>
