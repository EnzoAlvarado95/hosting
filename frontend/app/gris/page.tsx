...
export default function CasaAgua() {
  ...
  return (
    <div className="min-h-screen bg-white text-gray-800">
      ...
      <div className="max-w-5xl mx-auto p-4 sm:p-6 pt-28">
        ...
        {/* Título */}
        <h1 className="text-3xl sm:text-4xl font-bold mb-4">Casa Agua</h1>
        ...
        <div className="bg-gray-50 p-4 sm:p-6 rounded-2xl shadow mb-6">
          <h2 className="text-xl sm:text-2xl font-semibold mb-3">Dirección de la Casa Agua</h2>
          <p className="text-gray-800 leading-relaxed text-sm sm:text-base">
            Colonia: Barrio de Guadalupe Calle: Plande de ayutla #115 Edificio 1 Departamento 1 Aguascalientes, México
          </p>
        </div>
  ...
  <p className="text-gray-800 leading-relaxed text-sm sm:text-base">
    <a
      href="https://www.airbnb.com/h/andaligris"
      target="_blank"
      rel="noopener noreferrer"
      className="text-blue-600 hover:underline"
    >
      airbnb.com/h/andaligris
    </a>
  </p>
</div>
